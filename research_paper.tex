...
All authors contributed to both the technical implementation and writing process.
\textbf{Aidan Perez} contributed baseline evaluation development,
dependency and build fixes, project documentation updates, and core
manuscript integration. \textbf{Dang Dinh} contributed RAG evaluation
implementation, metrics refinement, references updates, and major
results/discussion revisions (including RQ3 and RQ4 updates).
\textbf{Kaveri Goel} contributed experiment-pipeline engineering,
including zero-shot/CoT/RAG workflow support, batching inference,
retrieval hyperparameterization (e.g., top-$k$), and associated
debugging fixes. \textbf{Ying Huang} contributed substantial manuscript
development and revision (including CoT, related work, results, and
future-work framing), as well as project coordination and final
consolidation. All authors reviewed and approved the final manuscript.
